...
//Karimmmmmmmmmmmmmmmm	
    $divfeedbacklist = html_writer::start_tag('div', array('id' => 'optionText', 'class'=>'optionText'));
	$divfeedbacklist .= html_writer::start_tag('span');
	$countfeedbacks = evoting_get_feedback_list.count();
	$sumOptions = 0;
	
	for ($i = 0; $i < $countfeedbacks; $i++) {
		$divfeedbacklist .= evoting_get_feedback_list(i);
	}
	
	$divfeedbacklist .= html_writer::end_tag('span');
	$divfeedbacklist .= html_writer::end_tag('div');
	echo $divfeedbacklist;
////////////////////////////////////////////////////////////////////////////////////
